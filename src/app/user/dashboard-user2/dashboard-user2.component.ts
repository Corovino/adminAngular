...
@Component({
  selector: 'app-dashboard-user2',
  templateUrl: './dashboard-user2.component.html',
  styleUrls: ['./dashboard-user2.component.css']
})
export class DashboardUser2Component implements OnInit {
